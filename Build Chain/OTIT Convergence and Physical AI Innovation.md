---
title: "OT/IT Convergence and Physical AI Innovation"
source: "https://www.hcltech.com/trends-and-insights/otit-convergence-enabling-next-wave-innovation-physical-ai"
author:
  - "[[Nicholas Ismail]]"
published: 2025-08-26
created: 2026-04-13
description: "Discover how OT/IT convergence, powered by AI and Physical AI, is reshaping industries with agility, security, efficiency, and competitive advantage. Read the blog!"
tags:
  - phase/manufacturing
  - system/digital-twin
type: clip
...
Industry data reinforces Acharya’s stance. In one recent survey, [33% of organizations](https://www.smartindustry.com/benefits-of-transformation/it-ot-convergence/article/33037347/industrial-ot-widely-vulnerable-to-intrusion-survey-finds) not pursuing OT/IT convergence cited security risk as a top reason for holding back. Acharya would likely call this cautious camp short-sighted.
...
He emphasizes that operational technology on the factory floor holds untapped potential that must be harnessed. Indeed, from [smart manufacturing](https://www.hcltech.com/digital-manufacturing) and [industrial IoT](https://www.hcltech.com/physical-ai-aiot) to real-time automation, major disruptions are happening in OT; far more than in back-office IT systems.
...
External market data backs this view. The technologies at the OT/IT intersection are booming. In 2024, the [addressable OT/IT integration market](https://iot-analytics.com/it-ot-convergence-27-themes-define-future-of-industrial-integration/) was about $720 billion and it’s projected to grow roughly 8.5% annually to surpass $1 trillion by 2027. Clearly, organizations see immense value in modernizing OT and bringing it together with IT, validating Acharya’s OT-first emphasis.
...
1. OT/IT and broader tech convergence as the integration layer
2. Micro capabilities that are adaptable and composable
3. Data intelligence prioritizes actionable insight over raw analytics
4. Compute smart, where processing happens wherever it’s most efficient: cloud, in-memory, near-edge or far-edge

This hybrid model is rapidly becoming a reality. According to Gartner, [75% of enterprise data will be created and processed at the edge by 2025](https://www.gartner.com/smarterwithgartner/what-edge-computing-means-for-infrastructure-and-operations-leaders), up from just 10% in 2018. This reflects the rise of distributed, smart computing.
...
AI AI and GenAI Article OT/IT Convergence: Enabling the next wave of innovation with Physical AI